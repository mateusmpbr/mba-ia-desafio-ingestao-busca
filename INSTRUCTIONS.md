...
1. **Busca**: Permitir que o usuário faça perguntas via **linha de comando (CLI)** e receba respostas baseadas apenas no conteúdo do PDF.
...
- Passos ao receber uma pergunta:
  ...
  1. Buscar os 10 resultados mais relevantes (k=10) no banco vetorial.
  1. Montar o prompt e chamar a LLM.
  1. Retornar a resposta ao usuário.
